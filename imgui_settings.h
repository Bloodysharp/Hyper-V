...
namespace c
{
	inline ImVec4 espglowcolor = ImColor(101, 87, 255, 255);
	inline ImVec4 EspBoxolor = ImColor(255, 255, 255);
	inline ImVec4 esplinecolor = ImColor(101, 87, 255, 255);
	inline ImVec4 accent = ImColor(255, 215, 0, 255);  
	inline ImVec4 black = ImColor(0, 0, 0, 255);

	inline ImVec4 ColorRojas = ImColor(255, 255, 255);
	...
	namespace bg
	{
		...
		inline ImVec2 size = ImVec2(790, 605);
		inline float rounding = 12;
	}

	namespace child
	{
		inline ImVec4 filling = ImColor(6, 9, 10, 270);
	...
	namespace element
	{
		...
		inline ImVec4 text = ImColor(120, 125, 150, 255);
		inline ImVec4 selector = ImColor(30, 31, 33, 80);
		inline ImVec4 background = ImColor(15, 16, 23, 255);
		inline ImVec4 background_widget = ImColor(255, 255, 255, .4);
		inline float rounding = 15;
		inline float roundingoxy = 9;
